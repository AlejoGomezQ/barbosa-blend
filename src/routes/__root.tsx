...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Café Barbosa" },
      { name: "description", content: "Buscamos mostrar el café que producen las fincas como un producto de excelente calidad, diferenciado por sus atributos en taza que lo caracterizan por su fragan" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Café Barbosa" },
      { property: "og:description", content: "Buscamos mostrar el café que producen las fincas como un producto de excelente calidad, diferenciado por sus atributos en taza que lo caracterizan por su fragan" },
